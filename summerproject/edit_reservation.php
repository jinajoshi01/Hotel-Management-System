...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE reservations SET reservation_id='$reservation_id', name='$name', email='$email', phone_number='$phone_number', room_type='$room_type', check_in_date='$check_in_date', check_out_date='$check_out_date' WHERE reservation_id='$reservation_id'";
...
<body>
    ...
    <form action="edit_reservation.php?id=<?php echo $reservation_id; ?>" method="POST" autocomplete="off">
